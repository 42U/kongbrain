...
import { LaqrumBrainContextEngine } from "../src/context-engine.js";
...
// ── 4. LaqrumBrainContextEngine.compact() — extracts structured signals ───────

describe("LaqrumBrainContextEngine.compact() — structured signal extraction", () => {
  it("extracts PENDING and FILES from session turns", async () => {
    ...
    const engine = new LaqrumBrainContextEngine(state);
...
// ── 5. LaqrumBrainContextEngine.ingest() — stashes user embedding ─────────────

describe("LaqrumBrainContextEngine.ingest() — user embedding stash", () => {
